...
const CAPABILITY_PROFILES: Record<PlatformId, PlatformSupportProfile> = {
  ...
  win32: {
    ...
    capabilities: {
      ...
      chromeBookmarkHistoryImport: { status: 'supported', notes: 'Windows Chrome bookmark and history import scans LOCALAPPDATA/Google/Chrome/User Data profiles, including AccountBookmarks.' },
      chromeCookieImport: { status: 'partial', notes: 'Windows cookie import uses CDP Network.getAllCookies or pre-exported JSON. On-disk Cookies/Network/Cookies remain DPAPI-encrypted; DPAPI decryption is not implemented.' },
